...
public class JoinRepositoryTests {
    ...
    @DisplayName("InnerJoin(내부 조인) 테스트")
    @Test
    ...
    @DisplayName("OuterJoin(외부 조인) 테스트")
    @Test
    ...
    @DisplayName("CollectionJoin(컬렉션 조인) 테스트")
    @Test
    ...
    @DisplayName("ThetaJoin(세타 조인) 테스트")
    @Test
    ...
    @DisplayName("FetchJoin(패치 조인) 테스트")
    @Test
